...
$r=mysql_query("update `master_class` SET `class`='$class',`roman`='$roman' where id='$edit'" );
$r=mysql_query($sql);
                    ...
                    <div class="modal-content">
						...
						<div class="form-group">
							...
							<div class="col-md-6">
								<div class="input-icon right">
								<i class="fa"></i>
								<input class="form-control" placeholder="Please Enter Class Name" required name="class" autocomplete="off" type="text" value="<?php echo $class;?>">
								</div>
