...
<a style="padding: 3px 15px; background-color:rgba(218, 73, 73, 0.74); color:#FFF;margin-left:30%" href="number_sheet.php?cls=<?php echo $cls; ?>&sec=<?php echo $sec; ?>&sub=<?php echo $sub; ?>&trm=<?php echo $trm; ?>&cat=<?php echo $cat; ?>" ><strong>Download</strong></a>
