...
while($fte_elev=mysql_fetch_array($stdunt_elev))
{
	 $sub_id_1[]=$fte_elev['subject_id'];
        ...
        <tr bgcolor="#E0A366">
            <th height="33"  width="22%" style="margin-left:5px">Exam</th>
			<?php 
		$st=mysql_query("select DISTINCT(term_id) from `master_architecture` where `marksheet_term_id`='$term_id'");
		while($ft=mysql_fetch_array($st))
		{
...
<th>Grade</th>
		...
		<tr bgcolor="#E0A366">
            ...
            <th height="31"  width="8%" style="margin-left:5px">Wt</th>
            <th height="31" width="8%"style="margin-left:5px">Wt</th>
 			<th height="31" width="8%"style="margin-left:5px">Oral/Pract</th>
			<th height="31" width="8%"style="margin-left:5px">Lit</th>
			<th height="31" width="8%"style="margin-left:5px">Total</th>
			<th height="31" width="8%"style="margin-left:5px">Point</th>
