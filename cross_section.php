...
<title>Report | Cross-Section</title>
</head>
	...
	<div class="page-content-wrapper">
		 <div class="page-content">
			...
			<div class="portlet-title">
				<div class="caption">
					<i class="icon-puzzle"></i> Cross Section
				</div>
			</div>
...
$(document).ready(function() {		
	...
	$(".user").live("change",function(){
		...
		if(t.length > 0){
		$.ajax({
			url: "ajax_cross_section.php?pon="+t,
    ...
    $(".user1").live("change",function(){
		...
		var t=$(".user").val();
		$.ajax({
			url: "ajax_cross_section.php?pon1="+s+"&pon="+t,
			}).done(function(response) {
			$("#rpt").html(""+response+"");
		});
		}
    ...
    $(".user2").live("change",function(){
		...
		$.ajax({
			url: "ajax_cross_section.php?pon1="+s+"&pon="+t+"&pon3="+u,
			}).done(function(response) {
			$("#sht").html(""+response+"");
		});
		}
