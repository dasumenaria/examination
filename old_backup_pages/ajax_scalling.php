...
include("database.php");
		...
		<div class="form-group">
						<label class="control-label col-md-3">Category</label> 
							<div class="col-md-4">
							   <div class="input-icon right">
									<i class="fa"></i>
									<select class="form-control ust select2me blue" required multiple="multiple" name="category_id[]" >
	...
	?>
		...
		<div class="form-group">
						<label class="control-label col-md-3">Maximum category Value</label> 
							<div class="col-md-4">
							   <div class="input-icon right">
									<i class="fa"></i>
									<input class="form-control input" value="" required type="text" name="maximum_category" aria-invalid="false">
								</div>
								<span class="help-block">
								Type Category Maximum Value</span>
							</div>
					</div>
		...
		<div class="form-group">
						<label class="control-label col-md-3">Scalling</label> 
							<div class="col-md-4">
							   <div class="input-icon right">
									<i class="fa"></i>
									<input class="form-control input" value="" required type="text" name="scalling" aria-invalid="false">
								</div>
								<span class="help-block">
								Type Scalling in Percentage(%)</span>
							</div>
					</div>
