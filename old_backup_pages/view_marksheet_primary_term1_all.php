...
<body>
	...
	$stdunt=mysql_query("select `id`,`roll_no`,`name`,`father_name`,`scholar_no` from `student` where `class_id`='$class_id' && `section_id` = '$section_id' ORDER BY `name` ASC");
...
<div class="a1">
    ...
    <table width="100%"  cellspacing="0px" height="300" cellpadding="0px" border="1" id="sample_1">
		...
		<tr>
			<th width="10%" height="35px">Sr.no</th>
