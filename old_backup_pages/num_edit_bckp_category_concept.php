...
<!-- BEGIN CONTAINER -->
		...
		?>
			...
			<div class="portlet-title">
				<div class="caption"  style="text-align:center;">
					<h3><i class="icon-puzzle"></i> Edit Detail Of Class: <?php echo $cl_romn; ?> and Section: <?php echo $sc_name; ?></h3>
				</div>
			</div>
						 ...
						 <div class="table-responsive">
								...
								<?php
									...
									{$col++;
										...
										$sets1=mysql_query("select `id`,`marks` from `student_marks` where `scholar_no`='$scholar_no' && `term_id`='$exam_id' && `subject_id`='$sub_id' && `master_exam_type_id`='$exam_type_id' && `exam_category_id`='$cat_id'");
 ...
 <a href="#" class="number" max="<?php echo $max_marks; ?>" stdnt_id="<?php echo $fets1['id']; ?>" stdnt_sub="<?php echo $retrive_type; ?>" data-type="text" data-pk="1" data-original-title="Enter Number"><?php echo $value_sub; ?></a>
									</td>
			...
			<?php	///////////////////////////////////////ELECTIVE	./////////////////////	?>				
							...
							<?php
									...
									<td style="text-align:center">
									<?php if($count>0){ ?>
										 <a href="#" max="<?php echo $max_marks; ?>" class="number" stdnt_id="<?php echo $fetch['id']; ?>" stdnt_sub="<?php echo $retrive_type; ?>" data-type="text" <?php if($count>0){?> disabled <?php } else{} ?> data-pk="1" data-original-title="Enter Number"><?php echo $value_sub; ?></a>
										<?php } else { ?> <?php } ?>
									</td>
...
FormEditable.init();
	...
	$('form input[type=text]').live('keyup', function(e){ 
		var no=eval($(this).val());
		 ...
		 else if('AB'==no OR 'M'==no OR 'T'==no OR no=='0')
		 {
