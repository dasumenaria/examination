...
$r=mysql_query("update `master_sub_subject` SET `name`='$updt_sub_subject'");
$r=mysql_query($sql);
...
<div class="page-content-wrapper">
    ...
    <div class="col-md-6">
			...
			<div class="portlet-title">
				<div class="caption">
					<i class="icon-puzzle"></i> Add Sub Subject
				</div>
			</div>
				...
				<form  class="form-horizontal" id="form_sample_2"  role="form" method="post"> 
					<div class="form-body">
                        ...
                        <div class="form-group">
							<label class="control-label col-md-3">Sub Subject Name</label>
							<div class="col-md-6">
			...
			<div class="portlet-title">
				<div class="caption">
					<i class="icon-puzzle"></i> Sub Subject View
				</div>
			</div>
			<div class="portlet-body form">
