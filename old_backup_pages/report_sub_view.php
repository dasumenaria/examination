...
$cat_id=$_POST['cat_id'];
  	...
  	echo "<script>
    location='report_sub_view.php';
    window.open('report_sub_show.php?cls=$class_id&sec=$section_id&exm=$exam_id&subject=$subject&cat=$cat_id','_newtab');
    </script>";
						...
						<div class="form-group">
							...
							<div class="col-md-4">
							   <div class="input-icon right">
								    ...
								    <?php 
									$query4=mysql_query("select * from `subject_allocation`");
