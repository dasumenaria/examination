...
<body style="background-color:#E6E6FA">
						...
						$setfortime2=mysql_query("select * from `time_table` where `term_id`='$term_id' && `category_id`='$category_id'");
						$fetcc=mysql_fetch_array($setfortime2);
						$time_from=$fetcc['time_from'];
						$time_to=$fetcc['time_to'];
						?>
